...
![GitHub Workflow Status (branch)](https://img.shields.io/github/workflow/status/enzomtpYT/pronote-api/Node.js%20linting%20and%20testing/master?label=tests&logo=github&style=flat-square)
[![MIT license](https://img.shields.io/badge/license-MIT-lightgray?style=flat-square)](LICENSE)
[![Latest release](https://img.shields.io/github/v/release/enzomtpYT/pronote-api?color=darkgreen&include_prereleases&label=Latest%20release&style=flat-square)](https://github.com/enzomtpYT/pronote-api/releases)
...
```
Le schéma parent des requêtes et mutations se trouve [à cet endroit](https://github.com/enzomtpYT/pronote-api/blob/master/src/server/schemas/parent.graphql)

Le schéma élèves des requêtes et mutations se trouve [à cet endroit](https://github.com/enzomtpYT/pronote-api/blob/master/src/server/schemas/student.graphql)

Le schéma commun des requêtes et mutations se trouve [à cet endroit](https://github.com/enzomtpYT/pronote-api/blob/master/src/server/schemas/common.graphql) 
